...
public class Miniom implements Enemigo{
    ...
    public Miniom(AssetManager assetManager,Vector3f posicionInicial,Vector3f posicionFinal){
        vida = 100;
        velocidad = (float) 5;
         DirectionalLight dl = new DirectionalLight();
        dl.setDirection(new Vector3f(20, 40, 20).normalizeLocal());
        enemigo = (Node) assetManager.loadModel("Models/Oto/OtoOldAnim.j3o");
        enemigo.setLocalScale(.40f);
